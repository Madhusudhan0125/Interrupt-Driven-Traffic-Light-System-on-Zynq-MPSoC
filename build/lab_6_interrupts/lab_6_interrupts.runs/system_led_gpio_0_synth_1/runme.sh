...
HD_PWD='C:/520lab_projects/lab6 - Copy/build/lab_6_interrupts/lab_6_interrupts.runs/system_led_gpio_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_led_gpio_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_led_gpio_0.tcl
